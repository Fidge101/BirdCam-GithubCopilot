...
class CameraStream:
    ...
    def __init__(self, rtsp_url: str, blank_frame_reconnect_threshold: int = 3) -> None:
        ...
        _ = blank_frame_reconnect_threshold
    ...
    def read_frame(self) -> np.ndarray | None:
        ...
        Automatic reconnect/failover is intentionally disabled so stream resets
        happen only when explicitly requested by the user.
        """
